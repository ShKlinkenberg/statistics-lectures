---
title: "ANOVA"
subtitle: "One-way independent & F-distribution"
author: "Klinkenberg"
date: "14 okt 2016"
output: 
...
```{r child="../../../topics/f-distribution/f-distribution.rmd"}
```

```{r child="../../../topics/ANOVA_one-way_independent/ANOVA_one-way_independent.rmd"}
```
