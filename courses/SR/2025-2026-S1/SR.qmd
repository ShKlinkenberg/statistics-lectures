---
title: "Statistical Reasoning 2025-2026"
subtitle: "Semester 1"
author: "Klinkenberg"
date: today
---

On this site you will find my statistics lectures for Statistical Reasoning.

```{r, echo=FALSE, warning=FALSE, message=FALSE, eval=FALSE}
course.path = "courses/SR/2025-2026-S1/"

files <- list.files(full.names = F, pattern = "\\.qmd", recursive = T)

files <- files[grep("SR.qmd", files, invert = TRUE)]
