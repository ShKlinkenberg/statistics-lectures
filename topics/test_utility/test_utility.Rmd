...
<p style="color:darkblue; font-size:200%; text-align: center;">With a corelation of zero,<br>selection is useless</p> <!-- [Dutch Tile](https://www.flickr.com/photos/paulussie/15582506882) -->
...
<p style="color:darkblue; font-size:200%; text-align: center;">Only if you select everyone<br>you can determine the quality of the procedure</p>
...
```{r, fig.align="center", asp=1/3, echo=FALSE}
x = seq(-4,4,.01)
...
* If criterion validity suffers from restriction of range, then the efficientcy argument does not hold.
   * Policy schould not be based on psychometric argumentation.
