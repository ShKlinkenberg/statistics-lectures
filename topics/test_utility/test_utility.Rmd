...
<tr>
<td style="background-color:red;   width: 50px; color:white;">FN</td>
<td style="background-color:green; width: 50px; color:white;"">TP</td>
</tr>
<tr>
<td style="background-color:green; width: 50px; color:white;">TN</td>
<td style="background-color:red;   width: 50px; color:white;">FP</td>
</tr>
</table>
