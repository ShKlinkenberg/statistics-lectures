...
![](https://upload.wikimedia.org/wikipedia/commons/5/5b/Glas_Guinness.jpg){.absolute top=400 right=-150 width="200" height="260" .fragment}
...
tail(cbind(mean.x.values, se.x.values))
```
