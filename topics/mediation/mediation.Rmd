...
Does the speed of recovery after sickness improve with the use of homeopatics of is this effect mediated by a healthy lifestyle?
...
plot(data$gebruik.homeopathisch.middel, data$snelheid.van.genezing, col = 'red', xlab="homeo", ylab="rocov")
