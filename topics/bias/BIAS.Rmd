...
```{r, echo=FALSE}
means <- aggregate(IQ.you ~ factor(male), data, mean)
```
...
cbind(IQ.you = data2$IQ.you, b.0 =fit$coefficients[1], b.1 = fit$coefficients[2], male = data2$male, error = fit$residuals)[12:15,]
```
