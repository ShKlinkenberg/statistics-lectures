...
b.1 = fit$coefficients[2] ## Beta coefficient for IQ
b.2 = fit$coefficients[3] ## Beta coefficient for motivation
```
...
To get a percentage of explained variance, it must be compared to the total variance. In terms of $F$-values:

$$\frac{{MS}_{model}}{{MS}_{total}}$$
