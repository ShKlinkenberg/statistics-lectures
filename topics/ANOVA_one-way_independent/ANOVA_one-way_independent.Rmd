...
---------|----------------|----|--------------|---------
Model    | ${MS}_{model} = \sum n_k(\bar{X}_k - \bar{X})^2$ | $k-1$ | $\frac{{MS}_{model}}{{df}_{model}}$ | $\frac{{MS}_{model}}{{MS}_{error}}$
Error    | ${MS}_{error} = \sum s_k^2 (n_k - 1)$            | $N-k$ | $\frac{{MS}_{error}}{{df}_{error}}$ | 
Total    | ${MS}_{total} = {MS}_{model} + {MS}_{error}$     | $N-1$ | $\frac{{MS}_{total}}{{df}_{total}}$ | 
...
<img src="../../../topics/ANOVA_one-way_independent/pie2.png" style="height:200px;" >
<img src="../../../topics/ANOVA_one-way_independent/pie1.png" style="height:200px;" >

------

<img src="../../../topics/ANOVA_one-way_independent/pie3.png" style="height:200px;" >
