...
reg.data <- data.frame(b_0, b_1, some, b_2, much, b_3, weight, b_4, some, weight, b_5, much, weight, expect, outcome)
...
Proportion of explained versus unexplained variance / model vs error / between vs within.
