...
<td style = "border: 5px solid beige; padding: 10px; color: beige; background-color: red;">Type I error <br>Alpha $\alpha$ </td>
<td style = "border: 5px solid beige; padding: 10px; color: black; background-color: lightgreen;">Correct <br>True positive = Power</td>
</tr>
<tr height="150px">
<td>Decide not<br>to reject $H_0$</td>   
<td style = "border: 5px solid beige; padding: 10px; color: black; background-color: lightgreen;">Correct <br> True negative</td>
<td style = "border: 5px solid beige; padding: 10px; color: beige; background-color: red;">Type II error <br>Beta $\beta$ </td>
</tr>
</table>
