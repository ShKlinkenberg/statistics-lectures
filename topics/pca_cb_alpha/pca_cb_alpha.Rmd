...
$$\alpha = \frac{N^2 \overline{cov}}{\sum s^2_{item} + \sum {cav}_{item}}$$
...
$$N^2 \overline{cov} = N^2 \times \frac{\sum {cav}_{item}}{N} = \frac{N}{N-1} \sum {cav}_{item}$$
...
$$\sum s^2_{item} + \sum {cav}_{item} = \sigma^2_x$$
