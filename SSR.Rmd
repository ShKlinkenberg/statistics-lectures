---
title: "2020-2021 Scientific and Statistical Reasoning"
output:
  html_document:
    df_print: kable
    pandoc_args: ["--output=2020-2021_SSR.html"] 
---
...
rm(list = ls())
lectures <- list.files(path = "courses/2020-2021_SSR/", pattern = "*handout.html", recursive = T, full.names = TRUE)
