---
title: "2021-2022 Scientific and Statistical Reasoning"
output:
  html_document:
    df_print: kable
    pandoc_args: ["--output=2021-2022_SSR.html"] 
---
...
rm(list = ls())
lectures <- list.files(path = "courses/2021-2022_SSR/", pattern = "*handout.html", recursive = T, full.names = TRUE)
