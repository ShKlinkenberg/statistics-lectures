---
title: "2020-2021 Wetenschapsfilosophie & Statistisch Redeneren"
output:
  html_document:
    df_print: kable
    pandoc_args: ["--output=2020-2021_WSR-PB.html"] 
---
...
rm(list = ls())
lectures <- list.files(path = "courses/2020-2021_WSR_PB/", pattern = "*handout.html", recursive = T, full.names = TRUE)
